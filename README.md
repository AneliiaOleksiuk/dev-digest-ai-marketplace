...
[`site/`](site/) — a static React app, hostable on GitHub Pages, that reads
a JSON index generated by `scripts/build-index.mjs`. See
[`site/README.md`](site/README.md) to run it locally and
...
- [docs/MARKETPLACE-UI-SPEC.md](docs/MARKETPLACE-UI-SPEC.md) — marketplace UI spec (implemented in `site/`)
